...
function Layout(props) {
    ...
    return  <React.Fragment>
                ...
                <BgPicture />
                <div className="wrapper flex flex-col justify-items-stretch h-full z-20">    
                    ...
                    <section className={`blog flex flex-col flex-grow flex-shrink-0 z-10 justify-start ${props.transparent ? "bg-transparent" : "bg-white"}`}>
                        <div className={`${props.classes} container mx-auto ${props.padding ? 'px-48' : null} flex flex-col`}>
                            {props.children}
                        </div>
                    </section>
                    
                    {/* {props.backtotop ? <BackButton top={true} /> : null}  */}
                     
                     <div className={`${btnStyles.backButtons} flex justify-center`}>
                        {/* <BackButton back={true} classes="w-16 hover:w-0" />
                        <BackButton top={true} classes="w-16 hover:w-0" /> */}
...
function BgPicture() {
    return <>
    <picture className="bg fixed top-0 z-0 h-screen">
        ...
        <img src="images/bg.jpg" className="fixed bottom-0"></img>
    </picture>
    </>
}
